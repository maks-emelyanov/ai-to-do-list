...
inputs = merge(
  local.env_config.locals.inputs,
  {
    ...
    auth_web_config_renderer_path = "${get_terragrunt_dir()}/../../../apps/auth-web/scripts/render-auth-config.mjs"
    auth_web_config_template_path = "${get_terragrunt_dir()}/../../../apps/auth-web/auth-config.template.js"
    auth_web_config_output_path   = "${get_terragrunt_dir()}/../../../apps/auth-web/public/auth-config.js"
  }
)
